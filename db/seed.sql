...
('Red Jasper', 'Red, yellow, brown', 6, 'Easily obtained', true, 'Gently energizing and suportive. Grounding and protecting the body strengthening the energy field.', '2023-04-11', true),
('Selenite', 'Clear', 2, 'Easily obtained', false, 'A conductor of energy, and its cleansing effects can be strongly felt on the system.', '2023-06-27', true);